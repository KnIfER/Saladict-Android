...
var FortListeners = [];
var FortStorageListeners = [];
window.listeners=FortListeners;
    ...
    var p = new Promise(function(res, reject){
      if(1||e.type===14){
        ...
        for(var i=0;i<fa.length;i++) {
          try{
            var win=fa[i].window.FortListeners;
      ...
      //if(0)
      for(var i=0;i<FortListeners.length;i++) {
        var x = FortListeners[i](e);
        console.log(x);
        if(x) {
          //return x;
          res(x)
...
rover.storage_set=function(brw, e, keys){
  ...
  if(isPlugin) {
    ...
    for(var i=0;i<FortStorageListeners.length;i++) {
      var x = FortStorageListeners[i](changes, e);
      console.log(x);
    }
